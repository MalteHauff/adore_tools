...
EXCLUDED_MODULES="lizard_docker make_gadgets apt_cacher_ng_docker catkin_docker ci_teststand cppcheck_docker cpplint_docker catkin_docker adore_if_bob adore_if_ibeo adore_vehicle_if keepmoving_if_ros"
